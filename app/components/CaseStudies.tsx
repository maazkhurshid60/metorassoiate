    ...
    >
      <div className="container-x relative">
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          ...
          <a
            href="#contact"
            className="group inline-flex shrink-0 items-center gap-2 border border-white/20 px-6 py-3.5 text-sm font-bold uppercase tracking-wide text-white transition-colors hover:border-amber-500 hover:text-amber-400"
          >
            Start your search
        ...
        <div className="reveal-children mt-14 grid gap-px overflow-hidden border border-white/10 bg-white/10 lg:grid-cols-3">
          {CASES.map((c, i) => (
            <article
              key={c.challenge}
              className="group flex flex-col bg-navy-900 p-8 transition-colors hover:bg-navy-850"
            >
              <div className="flex items-center justify-between">
                <span className="mono-label border border-amber-500/40 px-2.5 py-1 text-[9px] text-amber-400">
                  {c.tag}
                </span>
                <span className="mono-label text-2xl font-bold text-white/10">
              ...
              <p className="mt-3 flex-1 text-[15px] leading-7 text-ink-400">{c.body}</p>
              <div className="mt-7 flex items-end justify-between hair pt-5">
                <div>
                  <p className="display text-3xl text-amber-500">{c.metric}</p>
                  <p className="mono-label mt-1 text-[9px] text-ink-500">
                    {c.metricLabel}
                  </p>
                </div>
                <span className="inline-flex h-11 w-11 items-center justify-center border border-white/12 text-white transition-colors group-hover:border-amber-500 group-hover:bg-amber-500 group-hover:text-navy-950">
